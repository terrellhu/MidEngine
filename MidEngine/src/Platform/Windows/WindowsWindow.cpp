...
namespace ME {
	...
	ME::WindowsWindow::WindowsWindow(const WindowProps& props)
	{
		Init(props);
	}
	...
	void ME::WindowsWindow::OnUpdate()
	{
		glfwPollEvents();
		glfwSwapBuffers(m_Window);
	}

	void ME::WindowsWindow::SetVSync(bool enabled)
	{
		if (enabled)
		{
            glfwSwapInterval(1);
	...
	bool ME::WindowsWindow::IsVSync() const
	{
		return m_Data.VSync;
	}
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		ME_CORE_ASSERT(status, "Could not intialize Glad!");
